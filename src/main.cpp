...
uint256 hashGenesisBlock("0x75cd577d7f32d8eff4bfdc79d08a46e7eed5b237978eec8a1196c5055025a49e");
...
const string strMessageMagic = "CgtCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // CgtCoin: 1 days
static const int64 nTargetSpacing = 120; // CgtCoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal cgtcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "CgtCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "This is the Artificial Intelligence CPCGAS coin";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1478111769; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 769663;

        if (fTestNet)
        {
            block.nTime    = 1478111769;
            block.nNonce   = 769663;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x6461028e244ada855ba762b280b29e7670584234433b778dfaccf78bf705aba6"));
